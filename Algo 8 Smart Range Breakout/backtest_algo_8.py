...
# Strategy Parameters
ALGO_NAME = "Algo_8_Smart_Range_Breakout"
WINDOW = 20
MULTIPLIER = 0.5 # Padding multiplier
TP = 0.005
SL = 0.02
QTY = 100
WARMUP = 21
        ...
        for i in range(len(day_df)):
            ...
            if waiting_for_warmup:
                ...
                if counter < WARMUP:
                    ...
                    atr = calculate_atr(recent_prices)
                    padding = atr * MULTIPLIER
                    locked_upper = max(recent_prices) + padding
                    locked_lower = min(recent_prices) - padding
