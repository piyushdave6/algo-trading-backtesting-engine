...
# Strategy Parameters
ALGO_NAME = "Algo_5_SMA_Mean_Reversion"
WINDOW = 20
ENTRY_THRESHOLD = 0.01 # 1% deviation
EXIT_THRESHOLD = 0.005 # 0.5% deviation
TP = 0.01
SL = 0.01
QTY = 100
WARMUP = 21

def calculate_sma(prices_series):
...
def run_single_backtest(filepath):
    ...
    for day, day_df in df.groupby("Date"):
        ...
        for i in range(len(day_df)):
            ...
            # Algo 5 Logic: SMA Mean Reversion
            ...
            if position == 0:
                ...
                # Logic Exit: Price returns within ±0.5% of SMA
                if not exit_flag:
                    if abs(deviation) <= EXIT_THRESHOLD:
                        exit_flag = True
                        reason = "SMA Reversion"
